...
aStats devAiStats = {6,       NULL, (DEVSUPFUN) ai_init,
                     (DEVSUPFUN) ai_init_record, (DEVSUPFUN) ai_ioint_info,
                     (DEVSUPFUN) ai_read, NULL};
epicsExportAddress(dset, devAiStats);
aStats devAoStats = {6, NULL, NULL, (DEVSUPFUN) ao_init_record, NULL,
                     (DEVSUPFUN) ao_write, NULL};
epicsExportAddress(dset, devAoStats);
aStats devAiClusts = {
    6, NULL, (DEVSUPFUN) ai_clusts_init, (DEVSUPFUN) ai_clusts_init_record,
    NULL, (DEVSUPFUN) ai_clusts_read, NULL};
