...
sStats devStringinStats = {
    5, NULL, (DEVSUPFUN) stringin_init, (DEVSUPFUN) stringin_init_record, NULL,
    (DEVSUPFUN) stringin_read};
sStats devStringinEnvVar = {5,    NULL,       NULL,
                            (DEVSUPFUN) envvar_init_record, NULL,
                            (DEVSUPFUN) envvar_read};
